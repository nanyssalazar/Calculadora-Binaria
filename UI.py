...
"}")
        ...
        self.widget.setGeometry(QtCore.QRect(21, 11, 421, 331))
        ...
        self.gridLayout_5.addWidget(self.resultado, 0, 0, 1, 2)
        ...
        self.gridLayout_4.addWidget(self.universo, 0, 0, 1, 1)
        ...
        self.gridLayout_4.addWidget(self.conjA, 1, 0, 1, 1)
        ...
        self.gridLayout_4.addWidget(self.conjB, 2, 0, 1, 1)
        ...
        self.gridLayout_4.addWidget(self.conjC, 3, 0, 1, 1)
        self.gridLayout_5.addLayout(self.gridLayout_4, 1, 0, 1, 1)
        self.gridLayout_3 = QtWidgets.QGridLayout()
        self.gridLayout_3.setObjectName("gridLayout_3")
        self.gridLayout = QtWidgets.QGridLayout()
        self.gridLayout.setObjectName("gridLayout")
        self.btn_parentesis = QtWidgets.QPushButton(self.widget)
        self.btn_parentesis.setMinimumSize(QtCore.QSize(10, 35))
        ...
        self.gridLayout.addWidget(self.btn_a, 0, 1, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.btn_union, 0, 1, 1, 1)
        self.btn_conjA = QtWidgets.QPushButton(self.widget)
        self.btn_conjA.setMinimumSize(QtCore.QSize(75, 35))
        self.btn_conjA.setObjectName("btn_conjA")
        self.gridLayout_3.addWidget(self.btn_conjA, 1, 0, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.btn_interseccion, 1, 1, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.btn_conjB, 2, 0, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.btn_resta, 2, 1, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.btn_conjC, 3, 0, 1, 1)
        self.btn_producto = QtWidgets.QPushButton(self.widget)
        self.btn_producto.setMinimumSize(QtCore.QSize(0, 35))
        self.btn_producto.setObjectName("btn_producto")
        self.gridLayout_3.addWidget(self.btn_producto, 3, 1, 1, 1)
