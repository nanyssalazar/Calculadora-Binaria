...
"}")
        ...
        self.gridLayout.addWidget(self.btn_conjC, 5, 0, 1, 1)
        ...
        self.gridLayout.addWidget(self.btn_resta, 5, 2, 1, 1)
        ...
        self.gridLayout.addWidget(self.btn_interseccion, 2, 2, 1, 1)
        ...
        self.gridLayout.addWidget(self.btn_a, 4, 2, 1, 1)
        ...
        self.gridLayout.addWidget(self.btn_conjA, 2, 0, 1, 1)
        ...
        self.gridLayout.addWidget(self.btn_conjB, 4, 0, 1, 1)
        ...
        self.gridLayout.addWidget(self.btn_union, 1, 2, 1, 1)
        ...
        self.gridLayout.addWidget(self.btn_parentesis, 1, 0, 1, 1)
        self.btn_producto = QtWidgets.QPushButton(self.layoutWidget1)
        self.btn_producto.setMinimumSize(QtCore.QSize(0, 35))
        self.btn_producto.setObjectName("btn_producto")
        self.gridLayout.addWidget(self.btn_producto, 6, 2, 1, 1)
