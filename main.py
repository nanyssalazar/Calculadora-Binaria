...
def op_parentesis(string):
    conjunto = set()
    parentesis1 = string.index("(")
    parentesis2 = string.index(")")
    conj1 = string[parentesis1 + 1]
    conj2 = string[parentesis2 - 1]
    # si el primer conjunto es complemento
    if string[parentesis1 + 2] == "'":
        conj1 = conj1 + "'"
